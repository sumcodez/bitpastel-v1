  ...
  return (
    <section id='culture' className="md:pt-[90px] pt-[64px] bg-[#ffffff]">
      <div className="container mx-auto px-4">
        <h2 className="font-source font-[600] text-center text-title title md:mb-8 mb-4">
          Why work with us?
        </h2>
          ...
          <div className="work-with-us-features grid grid-cols-1 md:grid-cols-1 xl:gap-10 md:gap-6 gap-6">
            {features.map((feature, index) => (
              ...
              >
                ...
                <ul className='lg:pl-[57px] md:pl-[41px] pl-[36px] text-title'>
                  {feature.items.map((item, index) => (
                    <li key={index} className="md:leading-[1] leading-[normal] lg:list-disc list-none  font-roboto text-[16px] md:mb-3 mb-2">
                      {item}
                    </li>
                  ))}
                </ul>
