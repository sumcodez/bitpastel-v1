...
const ServicesSection = () => {
  ...
  const handleClick = (index: number) => {
    ...
    },
    {
      ...
      mobileIcon:'/images/img_icoutlinelaptop.svg',
    ...
    },
    {
      ...
      mobileIcon: '/images/img_iconoirdesignnib.svg',
      bgColor: 'bg-primary-yellow-light',
      bgcolorCollapsed:'#fcf4d7',
      mobileTextColor: "text-[rgba(240,198,56,1)]",
    },
    {
      ...
      mobileIcon:'/images/img_bicartplus.svg',
      bgColor: 'bg-primary-coral-light',
      bgcolorCollapsed:'#fde3e5',
      mobileTextColor: "text-[rgba(245,116,126,1)]",
    },
    {
      ...
      mobileIcon:'/images/img_lineiconscloudiot2.svg',
      bgColor: 'bg-primary-green-light',
      bgcolorCollapsed:'#d8f5e9',
      mobileTextColor: "text-[rgba(62,203,144,1)]",
    },
            ...
            activeIndex === index ? 'active' : ''
                    ...
                    >
                      ...
                      >
                        ...
                        <Image src={service.icon} alt={service.title} width={36} height={36} className='md:block hidden'/>
                        <Image src={service.mobileIcon} alt={service.title} width={36} height={36} className='md:hidden block'/>
