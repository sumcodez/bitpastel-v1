  ...
  >
    <svg fill="none" height="20" viewBox="0 0 24 21" width="20" className="">
      <path
        ...
        stroke={currentTab === 'home' ? "#008B8B" : "#008B8B"}
        strokeWidth="1.5"
        fill={currentTab === 'home' ? "#008B8B" : "none"}
      />
    </svg>
  ...
  >
    <svg fill="none" height="20" viewBox="0 0 21 21" width="20" className="">
      <path
        ...
        stroke={currentTab === 'services' ? "#008B8B" : "#008B8B"}
        strokeWidth="1.5"
        fill={currentTab === 'services' ? "#008B8B" : "none"}
      />
    </svg>
...
<div className={`nav-item flex flex-col items-center ${currentTab === 'stories' ? 'current' : ''}`}>
  ...
  >
    ...
    {/* Culture */}
    <div className={`nav-item flex flex-col items-center ${currentTab === 'culture' || pathname === '/culture' ? 'current' : ''}`}>
      <Link 
        href="/culture"
      ...
      >
        ...
        >
          <path
            ...
            strokeWidth="1.5"
            stroke={currentTab === 'culture' || pathname === '/culture' ? "#008B8B" : "#008B8B"}
            fill={currentTab === 'culture' || pathname === '/culture' ? "#008B8B" : "none"}
          />
        </svg>
    ...
    {/* Careers */}
    <div className={`nav-item flex flex-col items-center ${currentTab === 'careers' || pathname === '/careers' ? 'current' : ''}`}>
      <Link
        href="/careers"
        onClick={() => setCurrentTab('careers')}
        className="flex flex-col items-center"
      >
        <CareersIcon active={currentTab === 'careers' || pathname === '/careers'} />
