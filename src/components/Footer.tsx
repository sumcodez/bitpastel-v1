      ...
      <footer className="footer">
        ...
        <div className="root-mobile-nav fixed bottom-0 left-0 right-0 bg-white text-teal-600 shadow-lg lg:hidden z-50">
          <div className="footer-mobile-nav flex justify-around items-center py-2">
            ...
            {/* Services */}
            <div
              className={`nav-item flex flex-col items-center ${isClient && window.location.hash === '#services' ? 'current' : ''}`}
            >
              <button
                onClick={(e) => {
              ...
              >
                <svg fill="none" height="20" viewBox="0 0 21 21" width="20" className="">
                  <path
                    ...
                    stroke={
                      isClient && window.location.hash === '#services' ? '#008B8B' : '#008B8B'
                    }
                    strokeWidth="1.5"
                    fill={isClient && window.location.hash === '#services' ? '#008B8B' : 'none'}
                  />
                </svg>
            ...
            {/* Stories */}
            <div
              className={`nav-item flex flex-col items-center ${isClient && window.location.hash === '#stories' ? 'current' : ''}`}
            >
              <button
                onClick={(e) => {
                ...
                className="flex flex-col items-center"
              >
                <StoriesIcon active={isClient && window.location.hash === '#stories'} />
