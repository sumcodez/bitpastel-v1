...
export default function JoinTeam({ title = "Join Our Team", className, jobTitle }: JoinTeamProps) {
  ...
  const noticePeriodOptions = ["Immediately", "15 days", "1 month", "2 months", "3 months", "More than 3 months"]
  ...
  if (isSubmitted) {
    return (
      <div className={`${className ?? ""} max-w-[800px] mx-auto px-4 md:pt-[90px] pt-[70px] text-center`}>
        <p className="text-[#009999] text-[20px] font-roboto">Thank you {formData.name} for your job application!</p>
      </div>
    )
  }
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            >
              ...
              {errors.name && (
                <p className="text-red-500 text-xs sm:text-sm whitespace-nowrap mb-[2px]">{errors.name}</p>
              )}
            </div>

            <div
              className={`relative flex gap-2 pt-[6px] border-b ${
                errors.phone ? "border-red-500" : formData.phone ? "border-[#04ff04]" : "border-gray-300"
              }`}
            >
              <PhoneInput
                international
              ...
              {errors.phone && (
                <p className="text-red-500 text-xs sm:text-sm whitespace-nowrap mb-[2px]">{errors.phone}</p>
              )}
            </div>
          ...
          <div className="space-y-6">
            ...
            >
              ...
              {errors.email && (
                <p className="text-red-500 text-xs sm:text-sm whitespace-nowrap mb-[2px]">{errors.email}</p>
              )}
            </div>
            ...
            >
              ...
              />
              {errors.currentLocation && (
                <p className="text-red-500 text-xs sm:text-sm whitespace-nowrap mb-[2px]">{errors.currentLocation}</p>
              )}
            </div>
        ...
        <div className="pt-[10px]">
          ...
          <div
            className={`flex items-center gap-3 border-b ${
              errors.resume ? "border-red-500" : formData.resume ? "border-[#04ff04]" : "border-gray-300"
            }`}
          >
            <button
              type="button"
