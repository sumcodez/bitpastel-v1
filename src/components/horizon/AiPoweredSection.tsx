                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
                        <div className='flex justify-center items-left flex-col'>
                            ...
                            <h4 className='ai-powered-subtitle'>
                                Horizon becomes even more powerful when paired with Bitpastel’s AI-driven solutions. We bring advanced personalisation and automation into your Shopify store:
                            </h4>
