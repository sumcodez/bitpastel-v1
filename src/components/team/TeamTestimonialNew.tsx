...
const TeamTestimonialNew = () => {
  const testimonials: Testimonial[] = [
    ...
    },
    {
      ...
      testimonialMob: '/images/Testimonial Section/Chat boxes/Suman Naskar/suman-left-mob.png',
      rightSideTestimonial: '/images/Testimonial Section/Chat boxes/Suman Naskar/right.png',
      rightSideTestimonialMob: '/images/Testimonial Section/Chat boxes/Suman Naskar/suman-right-mob.png',
    },
    {
      id: 3,
      name: 'Ibrahim',
      ...
      testimonialMob: '/images/Testimonial Section/Chat boxes/Md Ibrahim/ibrahim-left-mob.png',
      rightSideTestimonial: '/images/Testimonial Section/Chat boxes/Md Ibrahim/right.png',
      rightSideTestimonialMob: '/images/Testimonial Section/Chat boxes/Md Ibrahim/ibrahim-right-mob.png',
    },
    {
      id: 4,
      name: 'Sneha',
    ...
    },
    {
      ...
      testimonialMob: '/images/Testimonial Section/Chat boxes/Sourav Saha/sourav-left-mob.png',
      rightSideTestimonial: '/images/Testimonial Section/Chat boxes/Sourav Saha/right.png',
      rightSideTestimonialMob: '/images/Testimonial Section/Chat boxes/Sourav Saha/sourav-right-mob.png',
    },
    {
      id: 6,
      name: 'Aditi',
